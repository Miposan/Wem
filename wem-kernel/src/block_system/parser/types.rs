...
// Re-export ParseWarning (defined in model layer) for parser internal use
pub use crate::block_system::model::ParseWarning;
...
/// 记录序列化过程中的降级处理
///
/// 某些 [`BlockType`](crate::block_system::model::BlockType) 在目标格式中无原生对应，会做降级处理。
